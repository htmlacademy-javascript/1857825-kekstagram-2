...
pristine.addValidator(textHashtagsElement, (value) => {
  if (!value.trim()) {
    return true;
  }
...
pristine.addValidator(textDescriptionElement, (value) => value.length <= 140, 'Длина комментария не может превышать 140 символов', 1, false);
...
export {textHashtagsElement, textDescriptionElement, formUploadElement, validateForm, pristine };
